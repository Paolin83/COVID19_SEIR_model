...
NB:  the file draft_analysis_italy_html.Rmd performs the same analysis enabling Javascript Pictures.
## The COVID dataset
...
We predict beta (and R0) for the next 14 days by means of a linear regressione model, assuming a Log-normal distribution for the beta (the slope) and forcing its value to be greater than 0.
```{r R0 forecast}
