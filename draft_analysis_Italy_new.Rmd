...
However, in the calculation of R0 we considered an infectious period of 21 days for two reasons:  
1) the majority of cases is asymptomatic;
2) 21 days is the worst scenario because in this period COVID19 symptoms can be confused with the concomitant FLU epidemic (https://www.webmd.com/lung/news/20200310/know-the-symptoms-of-covid19).  
