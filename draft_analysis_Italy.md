...
distribution for the beta (the slope) forcing is a value greater than 0.
...
R0 passes from values greater than 4 in the initial phase to values \<1
at the ending of the 14-days forecast.
