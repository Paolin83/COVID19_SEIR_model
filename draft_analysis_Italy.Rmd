...
```
The plot shows an exponential gros. We estimate the R0 parameter by means of a linear model. R0 indicates how contagious an infectious disease is. It's also referred to as "the reproduction number" of COVID19.
