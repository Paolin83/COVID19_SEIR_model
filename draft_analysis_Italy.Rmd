...
We calculate the R0 values based on a different number of days before the last. 
The R0 shows a decreasing trend, but it is stable in the last 12 days.
